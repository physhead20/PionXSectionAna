...
// Sat Jun 11 13:29:08 2016 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/KaonMinusAnaTree.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           ntracks_reco;
   Double_t        trkvtxx[27];   //[ntracks_reco]
   Double_t        trkvtxy[27];   //[ntracks_reco]
   Double_t        trkvtxz[27];   //[ntracks_reco]
   Double_t        trkendx[27];   //[ntracks_reco]
   Double_t        trkendy[27];   //[ntracks_reco]
   Double_t        trkendz[27];   //[ntracks_reco]
   Double_t        trkstartdcosx[27];   //[ntracks_reco]
   Double_t        trkstartdcosy[27];   //[ntracks_reco]
   Double_t        trkstartdcosz[27];   //[ntracks_reco]
   Double_t        trkenddcosx[27];   //[ntracks_reco]
   Double_t        trkenddcosy[27];   //[ntracks_reco]
   Double_t        trkenddcosz[27];   //[ntracks_reco]
   Int_t           trkWCtoTPCMath;
   Double_t        trklength[27];   //[ntracks_reco]
   Double_t        trkmomrange[27];   //[ntracks_reco]
   Double_t        trkmommschi2[27];   //[ntracks_reco]
   Double_t        trkmommsllhd[27];   //[ntracks_reco]
   Int_t           ntrkhits[27];   //[ntracks_reco]
   Double_t        trkx[27][1000];   //[ntracks_reco]
   Double_t        trky[27][1000];   //[ntracks_reco]
   Double_t        trkz[27][1000];   //[ntracks_reco]
   Double_t        trkpitch[27][2];   //[ntracks_reco]
   Int_t           trkhits[27][2];   //[ntracks_reco]
   Double_t        trkdedx[27][2][1000];   //[ntracks_reco]
   Double_t        trkrr[27][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[27][2][1000];   //[ntracks_reco]
   Double_t        trkke[27][2];   //[ntracks_reco]
   Double_t        trkpida[27][2];   //[ntracks_reco]
   Int_t           nTrajPoint[27];   //[ntracks_reco]
   Double_t        pHat0_X[27][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[27][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[27][1000];   //[ntracks_reco]
   Double_t        trjPt_X[27][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[27][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[27][1000];   //[ntracks_reco]
   Int_t           trkg4id[27];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[1615];   //[nhits]
   Int_t           hit_wire[1615];   //[nhits]
   Int_t           hit_channel[1615];   //[nhits]
   Double_t        hit_peakT[1615];   //[nhits]
   Double_t        hit_charge[1615];   //[nhits]
   Double_t        hit_ph[1615];   //[nhits]
   Double_t        hit_tstart[1615];   //[nhits]
   Double_t        hit_tend[1615];   //[nhits]
   Int_t           hit_trkid[1615];   //[nhits]
   Int_t           hit_trkkey[1615];   //[nhits]
   Int_t           hit_clukey[1615];   //[nhits]
   Int_t           hit_pk[1615];   //[nhits]
   Int_t           hit_t[1615];   //[nhits]
   Int_t           hit_ch[1615];   //[nhits]
   Int_t           hit_fwhh[1615];   //[nhits]
   Double_t        hit_rms[1615];   //[nhits]
   Double_t        hit_nelec[1615];   //[nhits]
   Double_t        hit_energy[1615];   //[nhits]
   Float_t         hit_dQds[1615];   //[nhits]
   Float_t         hit_dEds[1615];   //[nhits]
   Float_t         hit_ds[1615];   //[nhits]
   Float_t         hit_resrange[1615];   //[nhits]
   Float_t         hit_x[1615];   //[nhits]
   Float_t         hit_y[1615];   //[nhits]
   Float_t         hit_z[1615];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           pdg[395];   //[geant_list_size]
   Double_t        Eng[395];   //[geant_list_size]
   Double_t        Px[395];   //[geant_list_size]
   Double_t        Py[395];   //[geant_list_size]
   Double_t        Pz[395];   //[geant_list_size]
   Double_t        EndEng[395];   //[geant_list_size]
   Double_t        EndPx[395];   //[geant_list_size]
   Double_t        EndPy[395];   //[geant_list_size]
   Double_t        EndPz[395];   //[geant_list_size]
   Double_t        StartPointx[395];   //[geant_list_size]
   Double_t        StartPointy[395];   //[geant_list_size]
   Double_t        StartPointz[395];   //[geant_list_size]
   Double_t        EndPointx[395];   //[geant_list_size]
   Double_t        EndPointy[395];   //[geant_list_size]
   Double_t        EndPointz[395];   //[geant_list_size]
   Int_t           Process[395];   //[geant_list_size]
   Int_t           NumberDaughters[395];   //[geant_list_size]
   Int_t           Mother[395];   //[geant_list_size]
   Int_t           TrackId[395];   //[geant_list_size]
   Int_t           process_primary[395];   //[geant_list_size]
...
#ifdef KaonMinus_cxx
KaonMinus::KaonMinus(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/KaonMinusAnaTree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/KaonMinusAnaTree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/KaonMinusAnaTree.root:/anatree");
...
Int_t KaonMinus::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t KaonMinus::LoadTree(Long64_t entry)
{
...
void KaonMinus::Init(TTree *tree)
{
...
void KaonMinus::Show(Long64_t entry)
{
...
Int_t KaonMinus::Cut(Long64_t entry)
{
