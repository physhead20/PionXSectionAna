...
// Wed May 25 13:18:32 2016 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/PionAnaTree.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[75];   //[nclus]
   Double_t        clusterttick[75];   //[nclus]
   Double_t        cluendwire[75];   //[nclus]
   Double_t        cluendtick[75];   //[nclus]
   Int_t           cluplane[75];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[23];   //[ntracks_reco]
   Double_t        trkvtxy[23];   //[ntracks_reco]
   Double_t        trkvtxz[23];   //[ntracks_reco]
   Double_t        trkendx[23];   //[ntracks_reco]
   Double_t        trkendy[23];   //[ntracks_reco]
   Double_t        trkendz[23];   //[ntracks_reco]
   Double_t        trkstartdcosx[23];   //[ntracks_reco]
   Double_t        trkstartdcosy[23];   //[ntracks_reco]
   Double_t        trkstartdcosz[23];   //[ntracks_reco]
   Double_t        trkenddcosx[23];   //[ntracks_reco]
   Double_t        trkenddcosy[23];   //[ntracks_reco]
   Double_t        trkenddcosz[23];   //[ntracks_reco]
   Int_t           trkWCtoTPCMath;
   Double_t        trklength[23];   //[ntracks_reco]
   Double_t        trkmomrange[23];   //[ntracks_reco]
   Double_t        trkmommschi2[23];   //[ntracks_reco]
   Double_t        trkmommsllhd[23];   //[ntracks_reco]
   Int_t           ntrkhits[23];   //[ntracks_reco]
   Double_t        trkx[23][1000];   //[ntracks_reco]
   Double_t        trky[23][1000];   //[ntracks_reco]
   Double_t        trkz[23][1000];   //[ntracks_reco]
   Double_t        trkpitch[23][2];   //[ntracks_reco]
   Int_t           trkhits[23][2];   //[ntracks_reco]
   Double_t        trkdedx[23][2][1000];   //[ntracks_reco]
   Double_t        trkrr[23][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[23][2][1000];   //[ntracks_reco]
   Double_t        trkke[23][2];   //[ntracks_reco]
   Double_t        trkpida[23][2];   //[ntracks_reco]
   Int_t           nTrajPoint[23];   //[ntracks_reco]
   Double_t        pHat0_X[23][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[23][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[23][1000];   //[ntracks_reco]
   Double_t        trjPt_X[23][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[23][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[23][1000];   //[ntracks_reco]
   Int_t           trkg4id[23];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[1224];   //[nhits]
   Int_t           hit_wire[1224];   //[nhits]
   Int_t           hit_channel[1224];   //[nhits]
   Double_t        hit_peakT[1224];   //[nhits]
   Double_t        hit_charge[1224];   //[nhits]
   Double_t        hit_ph[1224];   //[nhits]
   Double_t        hit_tstart[1224];   //[nhits]
   Double_t        hit_tend[1224];   //[nhits]
   Int_t           hit_trkid[1224];   //[nhits]
   Int_t           hit_trkkey[1224];   //[nhits]
   Int_t           hit_clukey[1224];   //[nhits]
   Int_t           hit_pk[1224];   //[nhits]
   Int_t           hit_t[1224];   //[nhits]
   Int_t           hit_ch[1224];   //[nhits]
   Int_t           hit_fwhh[1224];   //[nhits]
   Double_t        hit_rms[1224];   //[nhits]
   Double_t        hit_nelec[1224];   //[nhits]
   Double_t        hit_energy[1224];   //[nhits]
   Float_t         hit_dQds[1224];   //[nhits]
   Float_t         hit_dEds[1224];   //[nhits]
   Float_t         hit_ds[1224];   //[nhits]
   Float_t         hit_resrange[1224];   //[nhits]
   Float_t         hit_x[1224];   //[nhits]
   Float_t         hit_y[1224];   //[nhits]
   Float_t         hit_z[1224];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           pdg[334];   //[geant_list_size]
   Double_t        Eng[334];   //[geant_list_size]
   Double_t        Px[334];   //[geant_list_size]
   Double_t        Py[334];   //[geant_list_size]
   Double_t        Pz[334];   //[geant_list_size]
   Double_t        EndEng[334];   //[geant_list_size]
   Double_t        EndPx[334];   //[geant_list_size]
   Double_t        EndPy[334];   //[geant_list_size]
   Double_t        EndPz[334];   //[geant_list_size]
   Double_t        StartPointx[334];   //[geant_list_size]
   Double_t        StartPointy[334];   //[geant_list_size]
   Double_t        StartPointz[334];   //[geant_list_size]
   Double_t        EndPointx[334];   //[geant_list_size]
   Double_t        EndPointy[334];   //[geant_list_size]
   Double_t        EndPointz[334];   //[geant_list_size]
   Int_t           Process[334];   //[geant_list_size]
   Int_t           NumberDaughters[334];   //[geant_list_size]
   Int_t           Mother[334];   //[geant_list_size]
   Int_t           TrackId[334];   //[geant_list_size]
   Int_t           process_primary[334];   //[geant_list_size]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/PionAnaTree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/PionAnaTree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/PionAnaTree.root:/anatree");
