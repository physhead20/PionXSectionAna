...
// Tue Aug 23 15:21:47 2016 by ROOT version 6.06/02
// from TTree anatree/analysis tree
// found on file: RunIData_AnaTree.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[747];   //[nclus]
   Double_t        clusterttick[747];   //[nclus]
   Double_t        cluendwire[747];   //[nclus]
   Double_t        cluendtick[747];   //[nclus]
   Int_t           cluplane[747];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[134];   //[ntracks_reco]
   Double_t        trkvtxy[134];   //[ntracks_reco]
   Double_t        trkvtxz[134];   //[ntracks_reco]
   Double_t        trkendx[134];   //[ntracks_reco]
   Double_t        trkendy[134];   //[ntracks_reco]
   Double_t        trkendz[134];   //[ntracks_reco]
   Double_t        trkstartdcosx[134];   //[ntracks_reco]
   Double_t        trkstartdcosy[134];   //[ntracks_reco]
   Double_t        trkstartdcosz[134];   //[ntracks_reco]
   Double_t        trkenddcosx[134];   //[ntracks_reco]
   Double_t        trkenddcosy[134];   //[ntracks_reco]
   Double_t        trkenddcosz[134];   //[ntracks_reco]
   Int_t           trkWCtoTPCMath;
   Double_t        trklength[134];   //[ntracks_reco]
   Double_t        trkmomrange[134];   //[ntracks_reco]
   Double_t        trkmommschi2[134];   //[ntracks_reco]
   Double_t        trkmommsllhd[134];   //[ntracks_reco]
   Int_t           ntrkhits[134];   //[ntracks_reco]
   Double_t        trkx[134][1000];   //[ntracks_reco]
   Double_t        trky[134][1000];   //[ntracks_reco]
   Double_t        trkz[134][1000];   //[ntracks_reco]
   Double_t        trkpitch[134][2];   //[ntracks_reco]
   Int_t           trkhits[134][2];   //[ntracks_reco]
   Double_t        trkdedx[134][2][1000];   //[ntracks_reco]
   Double_t        trkrr[134][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[134][2][1000];   //[ntracks_reco]
   Double_t        trkke[134][2];   //[ntracks_reco]
   Double_t        trkpida[134][2];   //[ntracks_reco]
   Int_t           nTrajPoint[134];   //[ntracks_reco]
   Double_t        pHat0_X[134][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[134][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[134][1000];   //[ntracks_reco]
   Double_t        trjPt_X[134][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[134][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[134][1000];   //[ntracks_reco]
   Int_t           trkg4id[134];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[16821];   //[nhits]
   Int_t           hit_wire[16821];   //[nhits]
   Int_t           hit_channel[16821];   //[nhits]
   Double_t        hit_peakT[16821];   //[nhits]
   Double_t        hit_charge[16821];   //[nhits]
   Double_t        hit_ph[16821];   //[nhits]
   Double_t        hit_tstart[16821];   //[nhits]
   Double_t        hit_tend[16821];   //[nhits]
   Int_t           hit_trkid[16821];   //[nhits]
   Int_t           hit_trkkey[16821];   //[nhits]
   Int_t           hit_clukey[16821];   //[nhits]
   Int_t           hit_pk[16821];   //[nhits]
   Int_t           hit_t[16821];   //[nhits]
   Int_t           hit_ch[16821];   //[nhits]
   Int_t           hit_fwhh[16821];   //[nhits]
   Double_t        hit_rms[16821];   //[nhits]
   Double_t        hit_nelec[16821];   //[nhits]
   Double_t        hit_energy[16821];   //[nhits]
   Float_t         hit_dQds[16821];   //[nhits]
   Float_t         hit_dEds[16821];   //[nhits]
   Float_t         hit_ds[16821];   //[nhits]
   Float_t         hit_resrange[16821];   //[nhits]
   Float_t         hit_x[16821];   //[nhits]
   Float_t         hit_y[16821];   //[nhits]
   Float_t         hit_z[16821];   //[nhits]
   Int_t           nwctrks;
...
#ifdef First_cxx
First::First(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("RunIData_AnaTree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("RunIData_AnaTree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("RunIData_AnaTree.root:/anatree");
...
Int_t First::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t First::LoadTree(Long64_t entry)
{
...
void First::Show(Long64_t entry)
{
...
Int_t First::Cut(Long64_t entry)
{
