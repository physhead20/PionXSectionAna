...
// Tue Aug 16 15:55:32 2016 by ROOT version 6.06/00
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/RunINeg_Data_Anatree.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/RunINeg_Data_Anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/RunINeg_Data_Anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/RunINeg_Data_Anatree.root:/anatree");
